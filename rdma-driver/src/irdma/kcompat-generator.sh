...
function gen-other() {
	...
	gen HAVE_PANIC_NOTIFIER_H if variable panic_notifier_list in include/linux/panic_notifier.h
	gen HAVE_FSNOTIFY_MASK_FIRST_ARG if fun fsnotify matches '[(] *__u32 *mask' in include/linux/fsnotify_backend.h
