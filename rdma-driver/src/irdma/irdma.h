...
#ifdef static_assert
static_assert((int)IRDMA_MAX_SHIFTS == (int)IRDMA_MAX_MASKS,
	      "irdma_shifts and irdma_masks mismatch");
#endif
...
int ig3rdma_post_cqp_create(struct irdma_sc_dev *dev);
void ig3rdma_post_cqp_destroy(struct irdma_sc_dev *dev);
#endif /* IRDMA_H*/
